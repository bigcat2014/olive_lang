...
struct TermNode
{
    /// @brief Alias for the variant of the Term stored in this node.
    using TermVariant
...
struct BinExprNode
{
    /// @brief Alias for the variant of the Binary Expression stored in this node.
...
struct ExprNode
{
    /// @brief Alias for the variant of the Expression stored in this node.
...
struct IfPredNode
{
    /// @brief Alias for the variant of the If Predicate stored in this node.
...
struct StmtNode
{
    /// @brief Alias for the variant of the Statement stored in this node.
