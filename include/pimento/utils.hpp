...
//! @details Sanitize the input path by expanding `~` and environment variables, normalizing the path, and ensuring it
//! is a file. Additionally checks the file extension and warns the user if the extension is not the expected `.oil`
//! extension.
