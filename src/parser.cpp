...
Parser::peek(size_t lookahead) const noexcept {
...
Parser::try_consume(tokenization::TokenType token_type) noexcept {
...
Parser::parse_expression(uint8_t min_precedence) {
  auto &logger = utils::get_logger();
